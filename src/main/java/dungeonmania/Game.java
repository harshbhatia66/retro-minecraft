...
public class Game {
    ...
    public Game build(String buildable) throws InvalidActionException {
        ...
        if (!buildables.contains(buildable)) {
            throw new InvalidActionException(String.format("%s Item cannot be built", buildable));
        } else if (buildable.equals("midnight_armour") && player.areZombiesPresent(map)) {
            throw new InvalidActionException(String.format("%s Item cannot be built", buildable));
        }
    ...
    public void setEnemiesDestroyedCount(int enemiesDestroyedCount) {
        this.enemiesDestroyedCount = enemiesDestroyedCount;
    }
}

...
public class InterfaceTest {
    ...
    class TickInterfaceTest {
        ...
        public void testTickInterfaceNormalOperation() {
            ...
            Game game = builder.setConfigName("c_InterfaceTest_testTickInterfaceNormalOperation")
                    .setDungeonName("d_InterfaceTest_testTickInterfaceNormalOperation").buildGame();
